...
######################################### Fim gráfico 4 ########################################################
dev.off()
pdf ("graphv2_Boxplot_ArtigoSaida.pdf", width = 11) #saida do segundo gráfico de forma solo
...
boxplot(boxData, xlab = "Intervalos de score dos usuários", ylab = "Porcentagem de ganho de fila")
